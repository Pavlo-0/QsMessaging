...
#pragma warning restore CS8618
        ...
        public async Task SubscribeAsync_WhenTwoHandlersExist_CreatesConsumerForEach()
        {
            ...
            _mockConsumerService.Setup(s => s.GetOrCreateConsumerAsync(It.IsAny<IChannel>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<HandlersStoreRecord>(), It.IsAny<CancellationToken>())).ReturnsAsync("tag");

            await _subscriber.SubscribeAsync();

            _mockConsumerService.Verify(s => s.GetOrCreateConsumerAsync(It.IsAny<IChannel>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<HandlersStoreRecord>(), It.IsAny<CancellationToken>()), Times.Exactly(2));
        }
        ...
        public async Task SubscribeHandlerAsync_ForMessageHandler_UsesQueuePermanentChannel()
        {
            ...
            _mockConsumerService.Setup(s => s.GetOrCreateConsumerAsync(_mockChannel.Object, queueName, exchangeName, record, It.IsAny<CancellationToken>())).ReturnsAsync("tag");
            ...
            _mockConsumerService.Verify(s => s.GetOrCreateConsumerAsync(_mockChannel.Object, queueName, exchangeName, record, It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task SubscribeHandlerAsync_ForEventHandler_UsesQueueConsumerTemporaryChannel()
        {
            ...
            _mockChannelService.Verify(s => s.GetOrCreateChannelAsync(RqChannelPurpose.QueueConsumerTemporary, It.IsAny<CancellationToken>()), Times.Once);
            _mockExchangeService.Verify(s => s.GetOrCreateExchangeAsync(_mockChannel.Object, typeof(TestModel), RqExchangePurpose.Temporary, It.IsAny<CancellationToken>()), Times.Once);
            _mockQueueService.Verify(s => s.GetOrCreateQueuesAsync(_mockChannel.Object, typeof(TestModel), exchangeName, RqQueuePurpose.ConsumerTemporary, It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task SubscribeHandlerAsync_PassesQueueNameFromQueueServiceToConsumerService()
        {
            ...
            _mockConsumerService.Setup(s => s.GetOrCreateConsumerAsync(It.IsAny<IChannel>(), expectedQueueName, "exchange", record, It.IsAny<CancellationToken>())).ReturnsAsync("tag");

            await _subscriber.SubscribeHandlerAsync(record);

            _mockConsumerService.Verify(s => s.GetOrCreateConsumerAsync(It.IsAny<IChannel>(), expectedQueueName, "exchange", record, It.IsAny<CancellationToken>()), Times.Once);
        }
